...
function Menu() {
    ...
    return (
        <>
            <div className="fixed left-[50vw] top-2 w-[36px] h-[36px] rounded-full bg-white cursor-pointer flex justify-center items-center z-40" onClick={() => setIsActive(!isActive)}>
