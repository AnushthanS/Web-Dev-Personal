...
function Divider() {
  ...
  return (
        <div className="h-[1px] w-[100vw] relative">
            ...
            <div onMouseEnter={() => handleMouseEnter()} onMouseMove={(e) => handleMouseMove(e)} onMouseLeave={() => handleMouseLeave()} className="h-[40px] relative z-10 border border-red-800 top-0"></div>

            <svg className="absolute top-[-30px] w-full h-[100px]">
